...
{
    public class OutputPdfGenerator : IOutPdfOutGenerator
    {
        ...
        private readonly ILogger<OutputPdfGenerator> _logger;

        public OutputPdfGenerator(ILogger<OutputPdfGenerator> logger)
        {
            _logger = logger;
        }

        public OutputPdfGenerator Create(List<IntelItem> items, string subject)
        {
            try
            {
...

        {
            ...
            public OutputPdfGenerator Save()
        {
            try
            {
                if (_result != null)
